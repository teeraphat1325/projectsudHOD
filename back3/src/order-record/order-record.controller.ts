...
export class OrderRecordController {
  ...
  create(
    ...
    // Only use authenticated user ID if no userId was provided in the DTO
    const userId =
  ...
  createFromCart(@Body() createOrderRecordDto: CreateOrderRecordDto) {
    return this.orderRecordService.createFromCart(createOrderRecordDto);
  }
